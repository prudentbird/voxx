...
- 8d9abd8: Fix a frontmatter-parsing regression from the gray-matter removal: an empty
...
- 85ad141: Drop the unmaintained `gray-matter` dependency and parse frontmatter with
